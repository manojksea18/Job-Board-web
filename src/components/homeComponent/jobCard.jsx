...
const JobCard=({job})=> {
  return (
    <div className='flex flex-col items-center justify-evenly ml-52 mr-52  mt-10 h-96 w-96 transition duration-150 ease-in-out transform hover:scale-105 hover:shadow-lg rounded-lg animate-pulse '>
        <div className=''>
            <div>
